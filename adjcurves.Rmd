...
We consider a study population of 10,000 patients who received a medication. 60% of the patients were women. A specific enzym was measured in 30% of the patients. Those with the enzym were more likely to receive the medication (with a probability of 75%), compared to those without the enyzm (probability of 50%).
...
An unadjusted Cox proportional hazard model shows that patients with medication have `r round(mod_cox_unadjusted$coef[1], 1)` higher hazard of death compared to those without medication.
...
What happens if we adjust for enzym and sex? Then the effect of the medication on death vanish (hazard ratio: `r round(mod_cox_adjusted$coef[1], 2)`.
...
This is confirmed by an IPW adjusted Cox regression model.
