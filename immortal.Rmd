...
`r sum(data_method4$exclude)` (`r round(sum(data_method4$exclude)/nrow(data_method4)*100, 1)`) individuals from both groups with a follow-uo time smaller than end of treatment duration were excluded.
